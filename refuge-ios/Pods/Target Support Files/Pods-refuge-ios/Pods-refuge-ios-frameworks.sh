...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "$BUILT_PRODUCTS_DIR/ADClusterMapView/ADClusterMapView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/HNKServerFacade/HNKServerFacade.framework"
